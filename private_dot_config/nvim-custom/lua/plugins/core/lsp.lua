    ...
    config = function(_, opts)
      ...
      for server, server_opts in pairs(opts.servers) do
        ...
        server_opts.on_attach = function(client, bufnr)
          ...
          -- setup folding
          if
            client.supports_method("textDocument/foldingRange") and require("utils.version").is_neovim_0_11_0()
          then
      ...
      if require("utils.version").is_neovim_0_11_0() and vim.g.native_lsp then
