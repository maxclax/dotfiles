...
function M.setup_terminal_keymaps()
  ...
  return {
    { ctrl_alt_slash, require("utils.terminal").toggle_split_terminal, mode = { "n", "i", "t", "v" }, desc = "Toggle split terminal" },
    { ctrl_alt_underscore, require("utils.terminal").toggle_split_terminal, mode = { "n", "i", "t", "v" }, desc = "Toggle split terminal" },
